...
<head>
    ...
    <style>
        ...
        .overlay {
            ...
            width: 100%;
            height: 100%;
            background-image: url(alaska.png);
            background-size: cover;
        }
    </style>
...
<body>
    ...
    <div class="overlay">
        <div class="ui-panel login-panel animated bounceInDown">
            <header>
                <div class="left logo">
                    <a href="Start.php"><span>Försvars</span><span1>makten</span1></a>
                </div>
            ...
            <footer>
                <div class="right form-actions">
                    <a href="#" class="button for login">Login</a>
                    <a href="NewUser_Form.php" class="button for register">Register</a>
                </div>
            </footer>
        </div>
    </div>
